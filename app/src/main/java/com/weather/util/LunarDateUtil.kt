...
class LunarUtil(cal: Calendar) {
    ...
    override fun toString(): String {
        return (year.toString() + "年" + (if (leap) "闰" else "") + chineseNumber[month - 1] + "月"
                + getChinaDayString(day))
    }

    companion object {
        internal val chineseNumber = arrayOf("一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二")
        internal var chineseDateFormat = SimpleDateFormat("yyyy-MM-dd")
